...
def create_settings():
    repository_settings = [
        ...
        {
            "name": "Use Azure File Share",
            "description": "Store installers in Azure File Share instead of the local container.",
            "key": "use_azure_file",
            "type": "boolean",
            "value": "False",
            "position": 7,
        },
        {
            ...
            "type": "string",
            "value": "",
            "depends_on": "use_azure_file",
            "position": 8,
        },
        {
            "name": "Azure file connection string",
            "description": "Connection string for Azure File Storage.",
            "key": "azure_file_connection_string",
            "type": "string",
            "value": "",
            "depends_on": "use_azure_file",
            "position": 9,
